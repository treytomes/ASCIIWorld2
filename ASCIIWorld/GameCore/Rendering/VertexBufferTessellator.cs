...
namespace GameCore.Rendering
{
	...
	public class VertexBufferTessellator : BaseTessellator
	{
		...
		public VertexBufferTessellator()
			: base()
		{
			Mode = VertexTessellatorMode.Render;
		...
		public VertexTessellatorMode Mode { get; set; }
		...
		public override void End()
		{
			foreach (var request in _requests)
			{
				...
				switch (Mode)
				{
					case VertexTessellatorMode.Render:
						vbo.Render(PrimitiveType, Shader);
						vbo.Dispose();
						break;
					case VertexTessellatorMode.Generate:
						GeneratedVBOs.Add(vbo);
						break;
				}
			}
		}
