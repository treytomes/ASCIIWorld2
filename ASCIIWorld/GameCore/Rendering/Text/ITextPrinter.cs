...
namespace GameCore.Rendering.Text
{
	...
	public interface ITextPrinter : IDisposable
	{
		...
		void Render(string text, Font font, Color color);
		...
		void Render(string text, Font font, Color color, RectangleF rect);
		...
		void Render(string text, Font font, Color color, RectangleF rect, TextPrinterOptions options);
		...
		void Render(string text, Font font, Color color, RectangleF rect, TextPrinterOptions options, TextAlignment alignment);
		...
		void Render(string text, Font font, Color color, RectangleF rect, TextPrinterOptions options, TextAlignment alignment, TextDirection direction);
