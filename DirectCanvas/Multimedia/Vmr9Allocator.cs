...
{
    delegate void NewAllocatorSurfaceDelegate(object sender, IntPtr pSurface, IntPtr sharedHandle, Size size);

    /// <summary>
    /// The Vmr9Allocator is a custom allocator for the VideoMixingRenderer9
    /// </summary>
    [ComVisible(true)]
    class Vmr9Allocator : IVMRSurfaceAllocator9, IVMRImagePresenter9
    {
        /// <summary>
...
#pragma warning restore 0414
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                InvokeNewSurfaceEvent(IntPtr.Zero, IntPtr.Zero, new Size());
        ...
        private static void CreateDevice()
        {
            ...
            if (IsVistaOrBetter)
            {
               int hr =  m_d3dEx.CreateDeviceEx(0, D3DDEVTYPE.D3DDEVTYPE_HAL, m_hWnd, CreateFlags.D3DCREATE_SOFTWARE_VERTEXPROCESSING | CreateFlags.D3DCREATE_MULTITHREADED, ref param, IntPtr.Zero, out dev);
            }
            else/* Windows XP */
            {
